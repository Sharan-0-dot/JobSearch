...
public class AgentController {
    ...
    public ResponseEntity<?> query(@RequestBody Map<String, String> request) {
        ...
        try {
            // This single call triggers the entire agent ReAct loop
            String response = jobSearchAgent.chat(userId, userMessage);
            ...
            executionTraceService.saveTrace(userId, userMessage, response, toolsUsed, executionTime);
    ...
    public ResponseEntity<?> getTraces(
        ...
        return ResponseEntity.ok(
                executionTraceService.getTracesByUser(
                        userId,
                        pageable
                )
        );
